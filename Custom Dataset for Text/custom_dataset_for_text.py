...
class Vocabulary():
	...
	def build_vocabulary(self, sentence_list):
		frequencies = {}
		idx = 4  # since we have index 0, 1, 2, 3 in self.itos
...
class FlickrDataset(Dataset):
	def __init__(self, root_dir, captions_file, transform=None, freq_threshold=5):
		...
		# getting images and caption columns
		self.imgs = self.df['image']
		self.captions = self.df['caption']

		# Initializing and building the vocabulary for text data
	...
	def __getitem__(self, index):
		...
		# converting the caption to numeric values
...
def main():
	...
	i = 0
	for batch_idx, (imgs, caption) in enumerate(data_loader):
		if i == 5:
			break
		print(imgs.shape)
		print(caption.shape)
